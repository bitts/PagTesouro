...
if( !isset($_REQUEST['save']) && !isset($_REQUEST['get']) ){
...
if( isset($_REQUEST['select']) || isset($_REQUEST['save']) || isset($_REQUEST['update'])  ){

    include("components/com_pagtesouro/pagtesouro-save.php");
